...
import com.example.admin.movie.adapter.customAdapter;
...
public class timefragment extends Fragment {
    ...
    int [] icon = {R.drawable.sangpemimpi, R.drawable.yowisben,R.drawable.negri5menara};
    String [] judul = {"Sang pemimpi","Yowis Ben 2","Negri 5 menara"};
    String [] deskripsi = {"12.00,15.00,17.30","13.00,14.50,18.10","16.00,19.10,20.30"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragmenttime, container, false);
        rootView.setTag(TAG);
